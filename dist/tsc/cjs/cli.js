...
yargs_1["default"](helpers_1.hideBin(process.argv))
    ...
    .command("$0 <files..>", "bundle jsonc", function (yargs) {
    return yargs
        .strictOptions(true)
        .option("output", {
        "default": "/dev/stdout",
    ...
    var output, files, _extends, e;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                output = args.output, files = args.files, _extends = args["extends"];
                e = Array.isArray(_extends)
                    ? _extends[_extends.length - 1]
                    : _extends;
                return [4 /*yield*/, index_1.jsoncBundler(files, {
                        output: output,
                        "extends": e
                    })];
            case 1:
